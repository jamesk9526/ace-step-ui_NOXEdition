...
export const translations = {
  en: {
    ...
    // Username Modal
    welcomeTitle: 'Welcome to OTunes By Oyama',
    ...
    emailBody: 'Hey!\n\nI created this AI-generated song and thought you\'d love it:\n\n"{title}" by {creator}\n{style}\n\nListen here: {url}\n\nMade with OTunes By Oyama - free and open source local AI music generation!',
  ...
  zh: {
    ...
    // Username Modal
    welcomeTitle: '欢迎使用 OTunes By Oyama',
    ...
    emailBody: '嘿！\n\n我创作了这首AI生成的歌曲，觉得你会喜欢：\n\n《{title}》- {creator}\n{style}\n\n点击收听：{url}\n\n使用 OTunes By Oyama 制作 - 免费开源的本地AI音乐生成工具！',
  ...
  ja: {
    ...
    // Username Modal
    welcomeTitle: 'OTunes By Oyamaへようこそ',
    ...
    emailBody: 'こんにちは！\n\n私がこのAI生成の曲を作りました。気に入ってもらえると思います：\n\n「{title}」by {creator}\n{style}\n\nここで聴いてください：{url}\n\nOTunes By Oyamaで作成 - 無料でオープンソースのローカルAI音楽生成！',
  ...
  ko: {
    ...
    // Username Modal
    welcomeTitle: 'OTunes By Oyama에 오신 것을 환영합니다',
    ...
    emailBody: '안녕하세요!\n\n제가 만든 이 AI 생성 곡을 들어보세요. 마음에 드실 거예요:\n\n"{title}" - {creator}\n{style}\n\n여기서 들으세요: {url}\n\nOTunes By Oyama로 제작 - 무료 오픈 소스 로컬 AI 음악 생성!',
